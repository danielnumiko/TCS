...
| **Interactive HTML/JSX prototype (Home / Donate / Story)** | `donate/index.html` — open in browser or [view live](https://danielnumiko.github.io/TCS/donate/) |
| **Interactive states prototype (every atom × every state)** | `states/index.html` — open in browser or [view live](https://danielnumiko.github.io/TCS/states/) |
